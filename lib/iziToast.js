...
(function (root, factory) {
    ...
    var iziToastTemplate = document.createElement('izi-toast-template');
    ...
    var $DOM = {
      toastCapsule: iziToastTemplate.$.toastCapsule,
      toast: iziToastTemplate.$.toast,
      toastBody: iziToastTemplate.$.toastBody,
      toastIcon: iziToastTemplate.$.toastIcon,
      icon: iziToastTemplate.$.icon,
      cover: document.createElement("div"),
      strong: iziToastTemplate.$.strong,
      p: iziToastTemplate.$.p,
      progressBar: iziToastTemplate.$.progressBar,
      progressBarDiv: iziToastTemplate.$.progressBarDiv,
      buttonClose: iziToastTemplate.$.buttonClose,
      buttons: iziToastTemplate.$.buttons,
      wrapper: null
    };
    ...
    // toast icon
    (function() {
      if (settings.toastIcon) {
        $DOM.toastIcon.icon = settings.toastIcon;
      } else {
        $DOM.toastIcon.style.display = 'none';
      }
    })();
    ...
    (function(toast){      
      ...
      var horizontalOffset = parseInt(settings.horizontalOffset);
      ...
      if (/left$/i.test(settings.position)) {
        // position is bottomLeft or topLeft
        toast.style.left = horizontalOffset + "px";
      } else if (/right$/i.test(settings.position)) {
        // position is bottomRight or topRight
        if (!isNaN(horizontalOffset)) {
          toast.style.right = horizontalOffset + "px";
        }
      } else {
        // position is center
        toast.style.left = horizontalOffset + "px";
    ...
    (function(toast){
      ...
      var verticalOffset = parseInt(settings.verticalOffset);
      ...
      if (/^bottom/i.test(settings.position)) {
        // position is bottomLeft, bottomRight or bottomCenter
        toast.style.bottom = verticalOffset + "px";
      } else if (/^top/i.test(settings.position)) {
        // position is topLeft, topRight or topCenter
